...
import { ArrowRight, ShieldCheck, Zap, HardDrive, Share2, FileText } from 'lucide-react';
      ...
      <nav className="landing-nav">
        <div className="landing-nav-container">
          <Link to="/" className="sidebar-logo" style={{ padding: 0 }}>
            <span className="sidebar-logo-text" style={{ fontSize: 24 }}>Cloud<span>Share</span></span>
          </Link>

          <div className="landing-nav-links">
            <a href="#features" className="nav-link">Features</a>
            <a href="#security" className="nav-link">Security</a>
            <a href="#storage" className="nav-link">Storage</a>
          </div>
